    ...
    protected void actionPerformed(GuiButton button) {
        switch (button.id) {
            ...
            case SENSITIVITY:
                ...
                break;
            case DEADZONES:
                mc.displayGuiScreen(new GuiControllerDeadZoneScreen(this));
                break;
            case AXES:
                mc.displayGuiScreen(new GuiControllerAxisScreen(this));
                break;
            case NAVIGATION:
            ...
            case MOD_BINDINGS:
                ...
                break;
            case RADIAL_MENU:
                mc.displayGuiScreen(new GuiRadialMenuSettingsScreen(this, gamepadManager, modKeyBindingController));
                break;
            case DONE:
