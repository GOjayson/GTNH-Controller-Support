...
public final class GuiControllerAxisScreen extends GuiScreen implements ControllerConfigurationScreen {
    ...
    public void initGui() {
        ...
        buttonList.add(new GuiButton(RESET_DEFAULTS, centerX - 100, 116, 200, 20, "Reset Axis Defaults"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        drawCenteredString(fontRendererObj, "Axis Inversion", width / 2, 16, 0xFFFFFF);
        drawCenteredString(
            fontRendererObj,
            "Each camera and cursor axis can be inverted independently",
            width / 2,
            32,
            0xA0A0A0);
