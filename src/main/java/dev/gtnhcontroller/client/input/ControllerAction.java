...
public enum ControllerAction {
    ...
    DROP_ITEM("Drop Item", "dropItem", false, "NONE"),
    ...
    MODIFIER_LAYER("Modifier Layer", "modifierLayer", false, "NONE"),
    GUI_CONFIRM("GUI Confirm / Left-click", "guiConfirm", true, "BUTTON:SOUTH"),
    GUI_QUICK_MOVE("Quick Move Stack", "guiQuickMove", true, "BUTTON:NORTH"),
    GUI_ALTERNATE("GUI Alternate / Right-click", "guiAlternate", true, "BUTTON:WEST"),
    GUI_BACK("GUI Back", "guiBack", true, "BUTTON:EAST"),
    GUI_KEYBOARD("On-screen Keyboard", "guiKeyboard", true, "BUTTON:BACK"),
